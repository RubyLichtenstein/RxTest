 ...
 */
inline fun <T, U : BaseTestConsumer<T, U>> createMatcher(crossinline assertion: (BaseTestConsumer<T, U>) -> Boolean,
                                                         failMessage: String)
 ...
 */
inline private fun <T, U : BaseTestConsumer<T, U>> applyAssertion(testConsumer: BaseTestConsumer<T, U>,
